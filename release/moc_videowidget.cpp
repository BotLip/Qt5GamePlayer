...
#include "../../XPlayer-master/videowidget.h"
...
QT_MOC_LITERAL(1, 12, 11), // "playChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 13), // "volumeChanged"
QT_MOC_LITERAL(4, 39, 5), // "value"
QT_MOC_LITERAL(5, 45, 15), // "positionChanged"
QT_MOC_LITERAL(6, 61, 8), // "sendFile"
QT_MOC_LITERAL(7, 70, 8), // "filename"
QT_MOC_LITERAL(8, 79, 10) // "fullScreen"

    },
    "VideoWidget\0playChanged\0\0volumeChanged\0"
    "value\0positionChanged\0sendFile\0filename\0"
    "fullScreen"
};
...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::playChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::volumeChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (VideoWidget::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::positionChanged)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::sendFile)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void VideoWidget::sendFile(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
